...
I18n.defaultLocale = "norwegian"; // If the current locale in device is not en or hi
...
export const setLanguageToNorwegian = () => {
...
export const getCurrentLocaleAsync = () => Expo.Util.getCurrentLocaleAsync(); // It will be used to define intial language state in reducer.
